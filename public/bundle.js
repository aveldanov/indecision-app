...
function (_React$Component) {
  ...
  function AddOption(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleAddOption", function (e) {
      e.preventDefault();
...
/* harmony import */ var _AddOption__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AddOption */ "./src/components/AddOption.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_React$Component) {
  ...
  function IndecisionApp() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidMount", function () {
      try {
        ...
        var json = localStorage.getItem('options'); //converts it from JSON string into array
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "componentDidUpdate", function (prevProps, prevState) {
      ...
      if (prevState.options.length !== _this.state.options.length) {
        ...
        localStorage.setItem('options', json); //console.log('saving data');
      }
    });
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function render() {
      ...
      return (//Passing down a method to Options to trigger the button
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Header__WEBPACK_IMPORTED_MODULE_1__["default"], {
          subtitle: subtitle
